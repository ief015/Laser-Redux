...
A devastating weapon up close. Unleash a large burst of lasers with the
potential of destroying multiple targets. Simply look at what ever you want to
die, and pull the trigger. Its alternative fire is a smaller, but more accurate
burst.
]]
...
if CLIENT then
	SWEP.DrawAmmo = false;
	SWEP.DrawCrosshair = false;
	SWEP.PrintName = "Scatter Nonce";
	SWEP.Author	= "ief015, rcdraco";
	SWEP.Slot = 2;
	SWEP.SlotPos = 0;
	SWEP.IconLetter = "s";
	SWEP.ViewModelFlip = false;
	killicon.AddFont("Scatter Nonce", "CSKillIcons", SWEP.IconLetter, Color(255, 80, 0, 255));
end
...
SWEP.CooldownMessage       = "Recharging";
